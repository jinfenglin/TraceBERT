...
python3 main.py --language java --data_dir '/afs/crc.nd.edu/user/j/jlin6/data/code_search_net' >&task.log
...
--per_gpu_train_batch_size 8 --overwrite_output_dir --seed 42 --eval_data_file ./data/train.txt >&task.log
